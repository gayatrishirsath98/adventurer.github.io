<%@ Page Title="" Language="C#" MasterPageFile="~/Client.master" AutoEventWireup="true" CodeFile="ViewOrderDetail.aspx.cs" Inherits="ViewOrderDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel2" runat="server" BorderColor="Black"
                        Height="150%" Style="width: 100%" BackColor="#FFFFCC" BorderStyle="Solid" HorizontalAlign="Center" Width="100%"><br />
            ...
            <div class="row">
                ...
                <div class="row center">
                    <asp:Button runat="server" ID="btn_back" CssClass="btn-danger" OnClick="btn_back_Click" Text="Back" />
