<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="AddNewPack.aspx.cs" Inherits="Admin_AddNewPack" %>
                                        ...
                                        <div class="review-content-section">
                                            <div class="input-group mg-b-pro-edt">
                                                ...
                                                <asp:TextBox runat="server" ID="txt_packname" 
                                                    class="form-control" placeholder="Pack Name" data-validation="required custom" data-validation-regexp="^([a-zA-Z ]+)$" ></asp:TextBox>
                                            </div>
                                            <div class="input-group mg-b-pro-edt">
                                                <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                <asp:TextBox runat="server" ID="txt_prize"   class="form-control" placeholder="Pack Prize" data-validation="required custom" data-validation-regexp="^([0-9 .]+)$"></asp:TextBox>
                                            </div>
                                            <div class="input-group mg-b-pro-edt">
                                                <span class="input-group-addon"><i class="fa fa-usd" aria-hidden="true"></i></span>
                                                <asp:TextBox runat="server" ID="txt_type"  class="form-control" placeholder="Pack Type" data-validation="required custom" data-validation-regexp="^([a-zA-Z ]+)$"></asp:TextBox>
                                            </div>
                                            <div class="input-group mg-b-pro-edt">
                                                <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
                                                <asp:TextBox runat="server" ID="txt_totalchannel"  class="form-control" placeholder="Total Channel" data-validation="required custom" data-validation-regexp="^([0-9]+)$"></asp:TextBox>
                                            </div>
                                             <div class="input-group mg-b-pro-edt">
                                                <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
