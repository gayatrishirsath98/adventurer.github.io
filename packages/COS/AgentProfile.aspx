<%@ Page Title="" Language="C#" MasterPageFile="~/Client.master" AutoEventWireup="true" CodeFile="AgentProfile.aspx.cs" Inherits="AgentProfile" %>
                                ...
                                <asp:Panel ID="Panel1" runat="server" BorderColor="Black" BorderStyle="Solid" Width="600px" HorizontalAlign="Center">
                                    ...
                                    <div class="card card-cascade">
                                        ...
                                        <div class="view view-cascade overlay">
                                            <asp:Image ID="Image1" Height="50%" Width="100%" runat="server" class="circle"></asp:Image>
                                            <a>
