<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="Register.aspx.cs" Inherits="Register" %>
                ...
                <table>
                    <tr>
                        <td>
                            ...
                            <asp:TextBox runat="server" ID="txt_name" class="form-control" data-validation="required custom" data-validation-regexp="^([A-Za-z ]+)$"></asp:TextBox>
                    ...
                    <tr>
                        <td>
                            <asp:Image ID="imgCaptcha" runat="server" BackColor="#FFFFCC" ForeColor="Black" BorderColor="Black" Height="56px" Width="205px" />
