<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="GenarateCaptcha.aspx.cs" Inherits="GenarateCaptcha" %>
    ...
    <table>
      ...
      <td align="middle">
          ...
          <tr><td style="height: 50px; width: 100px;">
              <asp:Image ID="imgCaptcha" runat="server" BackColor="Yellow" BorderColor="Black" ForeColor="Black" Height="32px" Width="143px" /></td>
              <td align="middle">
