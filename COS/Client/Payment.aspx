<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="Payment.aspx.cs" Inherits="Payment" %>
        ...
        <div class="col-md-6">
            ...
            <br />
             <asp:Panel ID="Panel1" runat="server" BorderColor="Black"
                    Height="100%" BackColor="#FFFFCC" BorderStyle="Solid" HorizontalAlign="Center" Width="100%">
            ...
            <div class="center">
               <hr />
            <asp:Image runat="server" id="paymoney" Height="180px" ImageUrl="~/Client/img/images.png" Width="366px"></asp:Image>
