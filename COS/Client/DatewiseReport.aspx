<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="DatewiseReport.aspx.cs" Inherits="DatewiseReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <form id="form1" runat="server">
         <div class="row">
            ...
            <div class="col-md-10">
                <br />
                <h4 style="color:crimson;text-align:center">Datewise Order Report </h4><br />
                <div class="row">
                    <div class="col-md-6">
