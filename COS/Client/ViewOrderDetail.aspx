<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="ViewOrderDetail.aspx.cs" Inherits="ViewOrderDetail" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <form id="form1" runat="server">
        ...
        <asp:Panel ID="Panel2" runat="server" HorizontalAlign="Center" Width="100%"><br />
