<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="TransactionReport.aspx.cs" Inherits="TransactionReport" %>
                ...
                <asp:Panel ID="panel1" runat="server">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <asp:TextBox runat="server" ID="txt_fromdate" placeholder="DD-MM-YYYY" required="true"></asp:TextBox>
                        </div>
                        <div class="col-md-6">
                            <asp:Label runat="server" Text="To Date"></asp:Label>
                            <asp:TextBox runat="server" ID="txt_todate" placeholder="DD-MM-YYYY" required="true"></asp:TextBox>
                        </div>
                        ...
                        <div class="col-md-12">
                            <table>
                                <tr>
                                     <td>
                                        <asp:RadioButton ID="rbtn_all" runat="server" GroupName="mode" Text="All" /></td>
