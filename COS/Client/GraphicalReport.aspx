<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="GraphicalReport.aspx.cs" Inherits="GraphicalReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Panel ID="Panel1" runat="server">
        <div class="row">
            ...
            <ChartAreas>
                <asp:ChartArea Name="ChartArea1">
                    <AxisY Title="Number Of Channels" TitleFont="Microsoft Sans Serif, 12pt, style=Bold">
                    </AxisY>
                    <AxisX Title="Pack Names" TitleFont="Microsoft Sans Serif, 12pt, style=Bold">
                    </AxisX>
                </asp:ChartArea>
            ...
            <Titles>
                <asp:Title  Font="Microsoft Sans Serif, 14.25pt, style=Bold" ForeColor="Red" Name="Title1" Text="Which Pack has Maximum Channel">
                </asp:Title>
            </Titles>
        </asp:Chart>
