<%@ Page Title="" Language="C#" MasterPageFile="~/Client/Client.master" AutoEventWireup="true" CodeFile="Bill.aspx.cs" Inherits="Bill" %>
            ...
            <div class="col-md-8" style="background-color: aliceblue; align-content: center;">
                <asp:panel id="Panel1" runat="server"
                    ...
                    <div class="row" style="background-color:lightpink"><br />
                        <div class="col-md-3">
                                <asp:Image runat="server" ID="lbl_logo" ImageUrl="~/Client/img/billlogo.png"  width="50%" height="50"></asp:Image>
                        </div>
                        <div class="col-md-9">
                            <table>
                                <tr>
                                    <td>
                                       &nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp; <asp:Image runat="server" ID="lbl_logoname" ImageUrl="~/Client/img/logo.png"></asp:Image>
                ...
                <div class="row center">
                    <asp:Button runat="server" ID="btn_print" OnClientClick="return PrintBill();" Text="Print" BackColor="#00CC00" Width="61px" />
