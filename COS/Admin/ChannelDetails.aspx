...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <form id="form1" runat="server">
        ...
        <div style="height: 424px">
            <asp:GridView ID="GridView1" runat="server" CssClass="GridPosition Gridview" Width="827px" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Height="185px" DataKeyNames="Channel_id" OnRowDataBound="GridView1_RowDataBound">
