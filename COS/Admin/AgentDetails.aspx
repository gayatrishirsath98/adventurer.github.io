...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <form id="form1" runat="server">
        ...
        <br />
        <asp:button id="btn_addagent" runat="server" text="Add New Agent" class="btn btn-ctl-bt waves-effect waves-light m-r-10" onclick="btn_addagent_Click" cssclass="pull-right" />
        <br />
        <br />
     <div class="container" >
       
              
            <asp:gridview id="GridView1" runat="server" CssClass="GridPosition Gridview"  height="315px" width="1092px" horizontalalign="Justify" datakeynames="Agent_id" cellpadding="3" backcolor="White" bordercolor="#999999" borderstyle="None" borderwidth="1px" gridlines="Vertical" onrowdatabound="GridView1_RowDataBound">
